...
const BasketScreen = () => {
  ...
  // go back and understand what exactly this does
  useMemo(() => {
      ...
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b border-[#00CCBB] bg-white shadow-xs">
          ...
          <TouchableOpacity
            ...
            className="rounded-ful absolute top-3 right-5"
          >
        ...
        <ScrollView>
          {Object.entries(groupedItemsInBasket).map(([key, items]) => {
            return (
              <View 
                key={key}
                className="flex-row items-center space-x-3 bg-white py-2 px-5 border border-gray-200"
              >
        ...
        <View className="p-5 bg-white mt-2 space-y-4">
            <View className="flex-row justify-between">
                ...
                <Text className="text-gray-400"><Currency quantity={basketTotal} currency="USD"/></Text>
            </View>
            <View className="flex-row justify-between">
